...
namespace ClassicDouDiZhu {
	...
	static void			card_info_print(const card_info& info);
	static bool			select_card_valid(const std::vector<int8_t>& vec_select_card);
	static bool			card_type_check(int card_type, int card_num, const std::vector<int8_t>& vec_val_num, int8_t& bg, int8_t& ed);

	//////////////////////////////////////////////////////////////////////////////

	static card_info*	card_info_generator(const std::vector<int8_t>& vec_select_card);
	static bool			card_info_valid(const card_info& info);
	static bool			card_info_compare(const card_info& bigger, const card_info& smaller);
	static void			card_info_help(const std::vector<int8_t>& vec_card, const card_info& smaller, std::vector<card_info>& vec_card_info);
